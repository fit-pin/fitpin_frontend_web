	...
	return (
		<div className={styles.App}>
			...
			>
				<div className={styles.content}>
					...
					<div className={styles.box}>
						집 앞 수선집에 직접 가지 않아도 되는 편리한 수선앱 핏핀.
						<br />
			...
			<div
				...
				className={`${styles.section} ${styles.blackBackground}`}
			>
			...
			<div
				...
				className={`${styles.section} ${styles.whiteBackground}`}
			>
				<div className={styles.step}>
			...
			<div
				...
				className={`${styles.section} ${styles.whiteBackground2}`}
			>
				<div className={styles.phone1}>
					<div className={styles.phone1_text}>
						<span className={styles.phone1_title}>
							클릭 한 번이면
							<br />
							수선이 뚝딱
							<br />
						...
						내가 선택한 제품을{' '}
						<span className={styles.phone1_bold}>
							원하는 핏으로
							<br />
						</span>
						<span className={styles.phone1_bold}>수선</span>할 수 있어요
						<br />
						<br />
						사고 싶은 제품을 선택한 뒤<br />
						<span className={styles.phone1_bold}>
							내가 원하는 핏으로 사이즈를 조절해요
							<br />
							<br />
						</span>
						번거롭게 수선집에 가지 않아도
						<br />
						<span className={styles.phone1_bold}>클릭 한 번</span>이면 수선된
						옷이
						<br />집 앞으로 <span className={styles.phone1_bold}>배송</span>돼요
					</div>
			...
			>
				<div className={styles.phone1}>
					<div className={styles.phone1_text}>
						...
						궁금한 제품의 사진을 찍으면
						<br />
						핏핀이 <span className={styles.phone1_bold}>사이즈</span> 정보를
						알려드려요
					</div>
			...
			<div
				...
				className={styles.whiteBackground2}
				style={{ backgroundImage: `url(${background2})`, marginTop: '4vh' }}
			>
				<div className={styles.phone1} style={{ marginLeft: '11vw' }}>
					<div className={styles.phone1_title2} style={{ marginRight: '9vw' }}>
						<h1 style={{ marginTop: '16vh', marginBottom: '-2vh' }}>
							내가 원하는 옷을
						</h1>
					...
					<img
						...
						style={{ marginTop: '5vh', marginLeft: '5vw' }}
					/>
				</div>
			</div>
